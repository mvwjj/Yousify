...
// Замените это на свои шрифты, если они у вас есть
// import com.veshikov.yousify.R (если шрифты в res/font)
...
val AppTypography = Typography(
    displayLarge = TextStyle(
        fontFamily = FontFamily.Default, // Замените на SansSerifFontFamily, если есть
    ...
    headlineSmall = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.SemiBold, // Сделаем чуть жирнее для заголовков поменьше
        fontSize = 24.sp,
        lineHeight = 32.sp,
        letterSpacing = 0.sp
    ),
